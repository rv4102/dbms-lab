...
QueryProcessor::QueryProcessor(int numFrames, policy policyType){
...
void QueryProcessor::processSelectQuery(FILE *file_pointer, int col1, string value){
    int numPages = 0;
...
void QueryProcessor::processJoinQuery(FILE *file_pointer1, FILE *file_pointer2, int col1, int col2){
...
int main(){
    ...
    FILE *file_pointer1 = fopen("fileBinary.bin", "rb");
    FILE *file_pointer2 = fopen("fileBinary.bin", "rb");
    ...
    QueryProcessor qp(numFrames, (policy)choice);
    ...
    if(queryType == 1){
        ...
        string value;
        cin>>value;
        qp.processSelectQuery(file_pointer1, col, value);
    }
    else if(queryType == 2){
        ...
        int col2;
        cin>>col2;
        qp.processJoinQuery(file_pointer1, file_pointer2, col1, col2);
    }
    else{
